...
- ### **изменение струкктуры программы**
  ...
  ```
    ...
    .if_not:
  ```
  Также были убраны такие команды как `endbr64` и `cdqe`. Благодаря подобным измененеиям код стал гораздо понятнее при чтении и также сократилось количество строк. Было 285, стало 261. Код находится в файлах `main.s` и `insertion.s`, так же в них есть подробные комментарии, описывающие работу программы.
